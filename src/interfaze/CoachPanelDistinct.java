...
public class CoachPanelDistinct extends JPanel {
	...
	for (Color col : colors) {
	    String str = String.format("cell %s %s", column, row);
    ...
    // frame.getContentPane().add(new CoachPanelDistinct());
